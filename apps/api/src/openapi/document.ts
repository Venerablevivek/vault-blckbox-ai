...
export const operations: Operation[] = [
  ...
  },
  {
    ...
    tag: 'Documents',
    summary: 'Upload a new version (multipart field "file")',
    description:
      'Becomes the current version; the previous one is kept. Same size limit, type check and malware scan as an upload. The file must be the same type as the document. Uploader or owner only.',
    auth: S,
    params: documents.DocumentParams,
    multipart: true,
    success: [201, documents.DocumentResponse],
  ...
  },
  {
    ...
    path: '/api/documents/:id/versions',
    tag: 'Documents',
    summary: 'Version history, current first',
    auth: S,
    params: documents.DocumentParams,
    success: [200, documents.VersionsResponse],
    errors: [401, 404],
  },
  {
    method: 'get',
    path: '/api/documents/:id/versions/:version/download',
    tag: 'Documents',
    summary: 'Download a version (redirect to a signed URL)',
    auth: S,
    params: documents.VersionParams,
    success: 'redirect',
    errors: [401, 404, 409, 410],
  },
  {
    ...
    params: documents.VersionParams,
    success: [200, documents.DocumentResponse],
    errors: [401, 403, 404, 409, 410, 413],
  },
  {
    method: 'delete',
    path: '/api/documents/:id/versions/:version',
    tag: 'Documents',
    summary: 'Delete an earlier version for good',
    auth: S,
    params: documents.VersionParams,
    success: [204, null],
    errors: [401, 403, 404, 409],
