...
export const operations: Operation[] = [
  ...
  },
  {
    ...
    tag: 'Documents',
    summary: 'Comments on a document, oldest first',
    description: 'Any member of the workspace, viewers included.',
    auth: S,
    params: documents.DocumentParams,
    success: [200, documents.CommentsResponse],
    errors: [401, 404],
  },
  {
    method: 'post',
    ...
    description:
      'Any member may comment, viewers included. The uploader and everyone already in the thread are notified. At most 500 comments per document.',
    auth: S,
    params: documents.DocumentParams,
    body: documents.CommentBody,
    success: [201, documents.CommentResponse],
  ...
  },
  {
    ...
    body: documents.CommentBody,
    success: [200, documents.CommentResponse],
    errors: [400, 401, 403, 404],
  },
  {
    method: 'delete',
  ...
  },
  {
    ...
    auth: S,
    success: [200, activity.NotificationPreferences],
    errors: [401],
  },
  {
    method: 'put',
    ...
    auth: S,
    body: activity.NotificationPreferencesBody,
    success: [200, activity.NotificationPreferences],
    errors: [400, 401],
  },
  {
